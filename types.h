...
typedef struct Value {
    ...
    int data_size;
    /*
     * Represents whether the object is reached when checking reachability.
     * 1 represents being reached, 0 implies the object is garbage.
     */
    int visited;
} Value;
...
typedef struct FloatValue {
    ...
    int data_size;
    /*
     * Represents whether the object is reached when checking reachability. 1
     * represents being reached, 0 implies the object is garbage.
     */
    int visited;
